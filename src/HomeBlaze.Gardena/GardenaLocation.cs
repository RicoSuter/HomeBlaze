...
namespace HomeBlaze.Gardena
{
    ...
    public class GardenaLocation : PollingThing, IIconProvider, IConnectedDevice, IAuthenticatedThing, IHubDevice, IPowerConsumptionSensor
    {
        ...
        [State(Unit = StateUnit.WattPerHour), JsonIgnore]
