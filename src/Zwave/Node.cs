...
namespace ZWave
{
    public class Node
    {
        ...
        {
            var nodeEventArgs = new NodeEventArgs(NodeID, command);
            MessageReceived?.Invoke(this, nodeEventArgs);
            ...
            {
                OnUnknownCommandReceived(nodeEventArgs);
            }
        }

        internal void HandleUpdate(NodeUpdateEventArgs e)
        {
